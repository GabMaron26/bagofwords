...
Original file is located at
    https://colab.research.google.com/drive/1D7gZb7L1rkp7fwavcmf46fXYCjCR3hl8
...
pag1 = BeautifulSoup(url.text, "html.parser")
frasesPag1 = []
pegarTexto1 = pag1.find_all("p")
for url in pegarTexto1:
    frasesPag1.append(url.get_text())

# pagina2
url2 = requests.get('https://www.qualtrics.com/experience-management/customer/natural-language-processing/')
pag2 = BeautifulSoup(url2.text, "html.parser")
frasesPag2 = []
pegarTexto2 = pag2.find_all("p")
for url2 in pegarTexto2:
    frasesPag2.append(url2.get_text())
